...
<<<<<<< src/test/java/com/likelion/devroutine/challenge/service/ChallengeServiceTest.java
...
class ChallengeServiceTest {
    ...
    private final ChallengeModifiyRequest challengeModifyRequest=
            new ChallengeModifiyRequest("modify title", "modify description", true, null);
